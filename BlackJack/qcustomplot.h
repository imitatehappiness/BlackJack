...
public:
  /*!
    Defines the strategies that the axis ticker may follow when choosing the size of the tick StepMonteCarlo.
    
    \see setTickStepStrategy
  */
  enum TickStepStrategy
  {
    tssReadability    ///< A nicely readable tick StepMonteCarlo is prioritized over matching the requested number of ticks (see \ref setTickCount)
...
public:
  /*!
    Defines how the axis ticker may modify the specified tick StepMonteCarlo (\ref setTickStep) in order to
    control the number of ticks in the axis range.
    
    \see setScaleStrategy
  */
  enum ScaleStrategy { ssNone      ///< Modifications are not allowed, the specified tick StepMonteCarlo is absolutely fixed. This might cause a high tick density and overlapping labels if the axis range is zoomed out.
                       ,ssMultiples ///< An integer multiple of the specified tick StepMonteCarlo is allowed. The used factor follows the base class properties of \ref setTickStepStrategy and \ref setTickCount.
                       ,ssPowers    ///< An integer power of the specified tick StepMonteCarlo is allowed.
                     };
  ...
  // setters:
  void setTickStep(double StepMonteCarlo);
...
protected:
  ...
  // non-property members:
  double mPiTickStep; // size of one tick StepMonteCarlo in units of mPiValue
...
public:
  ...
  */
  enum LineStyle { lsNone        ///< data points are not connected with any lines (e.g. data only represented
                   ...
                   ,lsStepLeft   ///< line is drawn as steps where the StepMonteCarlo height is the value of the left data point
                   ,lsStepRight  ///< line is drawn as steps where the StepMonteCarlo height is the value of the right data point
                   ,lsStepCenter ///< line is drawn as steps where the StepMonteCarlo is in between two data points
